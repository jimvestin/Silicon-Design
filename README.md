...
Det här är ett grupparbete där vi har byggt en webbsida utifrån den design vi fått. Sidan är byggd med HTML,CSS och lite JavaScript. Arbetet har delats upp mellan gruppmedlemmarna: Jim,Markus,Gökhan,Alexander

## Jim Vestin

Jag har arbetat med följande delar:
